...
class Enviaralert{
    ...
    public static function enviarEmailAlert($idchofer,$nombre,$asunto,$descripcion,$fecha,$email){
        ...
        */
          #templateHeader{
            /*@editable*/background-color:#3f3f3f;
            /*@editable*/background-image:url("https://gallery.mailchimp.com/cf6db962f7bbd0f24390c2132/images/93caf1e7-2446-4e79-89f3-cc59bff6f78f.png");
