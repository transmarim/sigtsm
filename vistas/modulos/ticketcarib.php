            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h1 class="box-title">Tickets Caribbean </h1>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Modulo Tickets Caribbean</h4>
              </div>
              <div class="modal-body">
                <div class="box-body">
                  <dl class="dl-horizontal">
                    <dt>Cliente</dt>
                    <dd style="text-align:justify">Seleccione el cliente que aparece en el ticket o boleta y al cual fue realizado el servicio, este debe
                      estar activo y/o previamente registrado en el sistema.</dd>
                    <dt>Chofer</dt>
                    <dd style="text-align:justify">Indique el chofer que ejecuto el servicio y/o boleta.</dd>
                    <dt>Buque</dt>
                    <dd style="text-align:justify">Seleccione el buque o centro de costo propocionado por el cliente para recargo del servicio, este debe
                      estar activo y/o previamente registrado en el sistema.</dd>
                    <dt>Codigo</dt>
                    <dd style="text-align:justify">Indique el codigo unico, que se encuentra en la parte superior derecha de la boleta o ticket de servicio
                      a ingresar.</dd>
                    <dt>Fecha de Pago</dt>
                    <dd style="text-align:justify">Agregue la fecha o semana en la cual se planea realizar el pago por el servicio, esta sera usada como
                      referencia para la elaboracion de reportes pronto pago.</dd>
                    ...
                    <dd style="text-align:justify">Campo automatico, su calculo esta establecido por el 1% por sobre la base o monto a pagar por concepto
                      de ISLR. Solo es modificable por el administrador del sistema.</dd>
                    <dt>Monto a Cobrar</dt>
                    <dd style="text-align:justify">Ingrese el monto a cobrar al cliente por el servicio, este campo no es obligatario, sirve solo para informacion
                      adicional.</dd>
                    <dt>Descripcion</dt>
