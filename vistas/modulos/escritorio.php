                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-aqua">
                                ...
                                <a href="tickettsm"><div class="icon"> <i class="ion ion-model-s"></i> </div></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-red">
                                ...
                                <a href="imprimiru"><div class="icon"> <i class="ion ion-printer"></i> </div></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-green">
                                ...
                                <a href="usuario"><div class="icon"> <i class="ion ion-ios-paper"></i></div></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-yellow">
                                ...
                                <a href="vehiculo"><div class="icon"> <i class="ion ion-ios-speedometer"></i> </div></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-aqua">
                                ...
                                <a><div class="icon"> <i class="ion ion-model-s"></i> </div></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-green">
