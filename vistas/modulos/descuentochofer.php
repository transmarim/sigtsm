                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="montodesc" id="montodesc" maxlength="20" placeholder="Monto descontado">
                          </div>
                           <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <label>% Descontado:</label>
                            <input type="text" class="form-control" name="porcentaje" id="porcentaje" maxlength="2" placeholder="Ingrese porcentaje">
                          </div>
