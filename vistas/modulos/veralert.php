        ...
        <small>Alertas generales de SIGTSM</small>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            <div class="box box-danger">
                                <div class="box-header with-border"> <i class="fa fa-address-card-o"></i>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="alert alert-success alert-dismissible">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        <h4><i class="icon fa fa-check"></i> Exito!</h4> Todas los cetificados estan vigentes. </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            <div class="box box-danger">
                                <div class="box-header with-border"> <i class="fa fa-medkit"></i>
