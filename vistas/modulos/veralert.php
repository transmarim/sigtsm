<?php
  if(!$_SESSION['validarTSM']){
      ...
      if($_SESSION['alertas']==1){
        include_once("vistas/modulos/inc/aside.php");
?>
<!-- INICIO DEL M.VERALERT -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="#">
                            <i class="fa fa-dashboard"></i> Alertas</a>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Certificados Vencidos</h3>
                            </div>
                            <div class="box-body">
                                <div id="ldanger2" class="alert alert-danger alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-ban"></i> Vencido!</h4>Los siguientes choferes tienen su certificado vencido:
                                ...
                                <div id="lwarning2" class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-warning"></i> Advertencia!</h4>Los siguientes choferes tienen su certificado proximo a vencer:
                                ...
                                <div id="lsuccess2" class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-check"></i> Exito!</h4> Todas las licencias estan vigentes. </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                <i class="fa fa-credit-card"></i>
                                <h3 class="box-title">Licencias Vencidas</h3>
                            </div>
                            <div class="box-body">
                                <div id="ldanger" class="alert alert-danger alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-ban"></i> Vencido!</h4>Los siguientes choferes tienen su licencia vencida:
                                ...
                                <div id="lwarning" class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-warning"></i> Advertencia!</h4>Los siguientes choferes tienen su licencia proxima a vencer:
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                <i class="fa fa-credit-card"></i>
                                <h3 class="box-title">Seguros Vencidos</h3>
                            </div>
                            <div class="box-body">
                                <div id="ldanger3" class="alert alert-danger alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-ban"></i> Vencido!</h4>Los siguientes Vehiculos tienen su seguro vencido:
                                    <ol id='seguroVencida'>
                                ...
                                <div id="lwarning3" class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-warning"></i> Advertencia!</h4>Los siguientes Vehiculos tienen su seguro proximo a vencer:
                                ...
                                <div id="lsuccess3" class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4>
                                        <i class="icon fa fa-check"></i> Exito!</h4> Todas los seguros estan vigentes. </div>
                            </div>
                        </div>
                    </div>
                </div>
