                  ...
                  <div class="modal-body">
                    <div class="box-body">
                      <dl class="dl-horizontal">
                        <dt>Nombre</dt>
                          <dd style="text-align:justify">Ingrese el nombre del buque que desea afiliar en el sistema, o en su defecto un centro de costo para las boletas de servicio.</dd>
                        </dl>
                    </div>
                  </div>
